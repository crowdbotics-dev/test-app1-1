"""
Django settings for test_app1_1 project.
...
WSGI_APPLICATION = 'test_app1_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app1_1 API",
    "DESCRIPTION": "API documentation for test_app1_1 App",
    "VERSION": "v1",
}
